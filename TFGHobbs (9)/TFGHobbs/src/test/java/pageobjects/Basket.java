...
public class Basket {
	...
	@FindBy(how = How.XPATH, using = "//div[@class='order-subtotal__value col-4']//p[@class='text-right grand-total']")
	public WebElement minicartTotal;

	// ...............p2_all_Basket..............................................................
	
	public List<WebElement> pdtWishlist() {
		return driver.findElements(By.xpath(
				"//div[@class='product-tile__name']//a"));
	}
	
	@FindBy(how = How.XPATH, using = "//div[@class='product-tile__name']//a")
	...
	public WebElement countryWindow;
	...
	@FindBy(how = How.XPATH, using ="//span[@class='cartRecsHeadingSpan']")
//			"//div[@class='cart cart-page']//div[@class='cart-recommendations']//h2[@class='custom-recommendations-title']//span[contains(text(),'Forgotten anything?')]")
	public WebElement recommendations1;

	@FindBy(how = How.XPATH, using = "//span[contains(text(),'You may also like')]")
	public WebElement recommendations2;
