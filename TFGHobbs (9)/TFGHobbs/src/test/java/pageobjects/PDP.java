...
public class PDP {
   ...
   //@FindBy(how = How.XPATH, using = "//div[@id='miniCart']//a[contains(text(),'View Bag & Checkout')]")
    ...
    @FindBy(how = How.XPATH, using = "//div[@class='minicart-total']//span[@class='minicart-quantity']")
	public WebElement viewBagAndCheckout;

	@FindBy(how = How.XPATH, using = "//div[@class='product-card__name']")
	...
	@FindBy(how = How.XPATH, using = "//*[contains(@id,'pdp')]/div[1]/a[1]/div/picture")
			//"//*[contains(@id,'pdp')]/div[1]/a[1]/div/div/img")
	public WebElement largeImage;

	@FindBy(how = How.XPATH, using = "//button[@class='lg-close lg-icon']")
	...
	@FindBy(how = How.XPATH, using = "//div[@class='wishlist__products row container-fluid justify-content-center']//div[@class='product-tile__body']//div[@class='pdp-link']")
	...
	public WebElement colorText(int value) {
		return driver.findElement(By.xpath("//p[@data-index='" + value + ".0']"));
	...
	@FindBy(how = How.XPATH, using = "//div[@class='minicart-total']//span[@class='minicart-quantity']")
	public WebElement miniQuantity;
}
