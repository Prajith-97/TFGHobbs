@DESKTOP_JOURNEY_3_AUS
Feature:RegisteredCustomer_CheckoutAsGuest_PayByCard_AUS
  Registered customer checking out as guest, apply filters on PLP, pay by card
 ...
 @LANDONHOMEPAGE
  ...
  Scenario: Enter customer details
    When user enters the customer details for "AU"
